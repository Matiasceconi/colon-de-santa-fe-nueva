...
const EVENT_ICONS = {
  ...
  training: Dumbbell, match: Trophy, wellness: Heart, rpe: Gauge, complementary: Dumbbell, kinesiology: Heart, equipment: ClipboardList, nutrition: Heart, video: Video, meeting: ClipboardList, travel: MapPin, evaluation: ClipboardList, meal: Heart, recovery: Heart, other: Calendar,
};
