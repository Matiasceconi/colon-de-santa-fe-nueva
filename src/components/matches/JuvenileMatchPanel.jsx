      ...
      >
        ...
        <div className="flex items-center gap-3 flex-1 justify-center px-3">
          <div className="flex items-center gap-2 min-w-0 flex-1 justify-end">
            <span className="text-xs text-zinc-300 hidden sm:block truncate max-w-[80px] text-right">{clubName}</span>
            <ClubLogo url={clubLogo} name={clubShort} size={8} />
          </div>
          ...
          <div className="bg-zinc-800/60 rounded-xl p-4">
            <div className="flex items-center justify-center gap-6">
              <div className="flex flex-col items-center gap-2">
                <ClubLogo url={clubLogo} name={clubName} size={16} />
                <p className="text-xs text-zinc-400 text-center">{clubName}</p>
              </div>
