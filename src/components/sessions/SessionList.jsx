...
export default function SessionList({ sessions, onSelect, onDelete, hasFilters = false, exerciseCounts = {}, playerCounts = {}, videoLinksBySession = {}, weeklyPlans = [], physicalObjectives = [] }) {
            ...
            <div className="flex flex-col xl:flex-row xl:items-stretch">
              ...
              <div className="flex flex-wrap xl:flex-nowrap items-center gap-0 border-t xl:border-t-0 xl:border-l border-zinc-800/80 px-3 py-3 xl:py-0" onClick={(e) => e.stopPropagation()}>
                <div className="grid grid-cols-2 sm:grid-cols-4 xl:flex gap-0 w-full xl:w-auto">
                  <div className="px-4 py-2 border-r border-zinc-800/80 text-center"><p className="text-white font-bold flex items-center justify-center gap-1"><Users size={13} />{playerCounts[session.id] || 0}</p><p className="text-[11px] text-zinc-500">Jugadores</p></div>
