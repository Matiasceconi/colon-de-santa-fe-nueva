                ...
                <button onClick={() => toggleEx(station.id)} className="w-full flex items-center gap-3 p-3 text-left hover:bg-zinc-800/30">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap mt-0.5">
                      ...
                      <span className="text-xs text-zinc-500">{series.length} series · {summarizeSeries(series)} · {summarizeLoads(series)}</span>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 shrink-0">
                    {station.rir && <span className="text-[10px] text-amber-300">RIR {station.rir}</span>}
                    {station.rest_time && (
