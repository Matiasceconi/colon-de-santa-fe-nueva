import { inferPositionGroup } from "@/lib/sportsStructure";
...
export const POSITION_GROUPS = {
  "Arqueros":       ["Arquero"],
  "Defensores":     ["Defensor", "Defensor Central", "Lateral Derecho", "Lateral Izquierdo", "Carrilero"],
  "Mediocampistas": ["Mediocampista", "Mediocampista Central", "Volante", "Volante Interno"],
  "Extremos":       ["Extremo", "Extremo Izquierdo", "Extremo Derecho"],
  "Delanteros":     ["Delantero", "Delantero Centro"],
};
...
export function resolvePositionGroup(position) {
  ...
  return inferPositionGroup(position) || null;
}