...
export function isFinishedMatch(match) {
  ...
  if (String(match.date) === today) return hasResult;
  // Compatibilidad histórica: partidos de fechas anteriores se consideran jugados
  // aunque el campo status legado haya quedado en "activo".
  return String(match.date) < today;
}
