  ...
  return (
    <div className="p-6 space-y-5">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <h1 className="text-xl font-bold text-white flex items-center gap-2"><ShieldCheck size={20} className="text-emerald-400" /> Mapeo de clubes externos</h1>
          <p className="text-xs text-zinc-500 mt-1">Vinculación entre nombres/IDs de proveedores y RivalClub · {stats.total} mapeos. La identidad institucional se edita en Configuración General.</p>
        </div>
