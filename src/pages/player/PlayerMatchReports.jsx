...
export default function PlayerMatchReports() {
  ...
  const clubBrand = { name: brand.club_name, shortName: brand.short_name, logoUrl: brand.logo_url, colors: { ink: "#111827", greenDeep: "#0F172A" } };
  ...
  async function handleDownload(report) {
    ...
    try {
      ...
      await exportMatchReportPdf({ reportData, reportMeta: { title: report.title }, staffComment: report.staff_comment, reportConfig: reportData.reportConfig, clubBrand });
    } catch (e) {
      console.error(e);
    } finally {
      setExporting(false);
